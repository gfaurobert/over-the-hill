...
exports.demonstrateTestScriptGeneration = demonstrateTestScriptGeneration;
const testScriptGenerator_1 = require("./testScriptGenerator");
const specAnalyzer_1 = require("./specAnalyzer");
...
async function demonstrateTestScriptGeneration() {
    ...
    const generator = new testScriptGenerator_1.TestScriptGenerator();
    const analyzer = new specAnalyzer_1.SpecAnalyzer();
    ...
    const mockCriteria = [
        {
            ...
            testable: true,
            category: qaConfig_1.QA_CONFIG.TEST_CATEGORIES.UI_INTERACTION,
            steps: [],
            requirementId: '1',
        ...
        },
        {
            ...
            testable: true,
            category: qaConfig_1.QA_CONFIG.TEST_CATEGORIES.ACCESSIBILITY,
            steps: [],
            requirementId: '2',
